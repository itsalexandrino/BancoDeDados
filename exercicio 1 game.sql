...
insert into tb_personagem (nome,pontosVida,danoAtaque,danoHabilidade,classeId) 
values("Kirito",100,60,10,3);

insert into tb_personagem (nome,pontosVida,danoAtaque,danoHabilidade,classeId) 
values("Anduin",25,10,60,2);

insert into tb_personagem (nome,pontosVida,danoAtaque,danoHabilidade,classeId) 
values("Valeera",60,40,20,4);

insert into tb_personagem (nome,pontosVida,danoAtaque,danoHabilidade,classeId) 
values("Gul'dan",30,5,80,1);

insert into tb_personagem (nome,pontosVida,danoAtaque,danoHabilidade,classeId) 
values("Rexxar",100,25,10,5);

insert into tb_personagem (nome,pontosVida,danoAtaque,danoHabilidade,classeId) 
values("Alvez",150,150,9,3);

insert into tb_personagem (nome,pontosVida,danoAtaque,danoHabilidade,classeId) 
values("Legolas",200,50,20,5);

insert into tb_personagem (nome,pontosVida,danoAtaque,danoHabilidade,classeId) 
values("Mascah",30,30,170,2);
